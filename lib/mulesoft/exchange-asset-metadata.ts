 ...
 * each with a valid `exchange.json` + `asset.json` pair) and real published
 * exchange.json examples elsewhere in the MuleSoft-Agent-Network-Project source.
 *
