...
export function getOAuthScopes(): string {
  return (
    ...
    "profile read:exchange manage:exchange view:monitoring read:api_configuration read:api_policies manage:api_policies manage:api_proxies read:client_applications read:api_contracts manage:store_data read:runtime_fabrics read:applications read:servers manage:application_data read:full"
  );
}
