...
export const AGENT_NETWORK_YAML_CONNECTION: ExchangeJsonNestedDoc = {
  ...
  fields: [
    ...
    },
    {
      ...
      composerSource: "derived",
      notes:
        "Deploy-time URL. Builder emits ${group.url} referencing exchange.json metadata.variables. LLM assets default to the provider base URL from the Agent Network yaml reference (OpenAI, Gemini, Azure OpenAI, Bedrock OpenAI).",
    },
    {
