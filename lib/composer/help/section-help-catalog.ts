...
const SECTION_HELP: Record<SectionHelpId, HelpEntry> = {
  ...
  "section.structuredOutputs": {
    ...
    gotchas: [
      ...
      "UI supports recursive object/array schemas, typed defaults, enum, pattern, and documented bounds",
  ...
  "field.onExitTarget": {
    ...
    gotchas: [
      ...
      "Artifact and non-terminal status echoes must transition onward",
      "Completed, failed, canceled, and rejected status echoes are terminal",
      "Builder validation requires every reachable path to a terminal status echo",
    ],
