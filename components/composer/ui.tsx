...
export function TextField({
  ...
  const inputClassName = isProtected
    ...
    : `w-full rounded-anypoint border px-2.5 py-1.5 text-sm shadow-sm transition-anypoint focus:outline-none focus:ring-2 focus:ring-offset-2 ${trailing ? "pr-20" : ""} ${borderCls} ${mono ? "font-mono" : ""} ${error ? "text-red-900" : readOnly ? "cursor-default focus:ring-0" : "bg-composer-surface text-gray-900"}`;
